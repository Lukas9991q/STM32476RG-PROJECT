...
#define BKLIT_CCR					CCR1			//preload register
#define BKLIT_STBY_LEVEL 			3				//Display backlight level when in stand-by (levels are CNT values)
#define BKLIT_INIT_LEVEL 			8			//Display backlight level on startup
#endif
